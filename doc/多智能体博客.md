...
[Equipping agents for the real world with Agent Skills](/blog/equipping-agents-for-the-real-world-with-agent-skills)Equipping agents for the real world with Agent Skills
...
[Building agents with the Claude Agent SDK](/blog/building-agents-with-the-claude-agent-sdk)Building agents with the Claude Agent SDK
...
[Building agents with Skills: Equipping agents for specialized work](#)Building agents with Skills: Equipping agents for specialized work

[Building agents with Skills: Equipping agents for specialized work](/blog/building-agents-with-skills-equipping-agents-for-specialized-work)Building agents with Skills: Equipping agents for specialized work
